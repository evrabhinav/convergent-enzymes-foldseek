...
empirical anomaly motivating our analysis.
...
few-shot, homology removed). Our ensemble (red) ties the DGEB AA-best
...
Every ensemble configuration we tested clears the DGEB ESM2-3B
baseline (dashed line at $0.680$); our best at $0.730$.}
\label{fig:ec}
\end{subfigure}
\caption{Per-method comparison on the two DGEB classification tasks
we evaluate. Bars are weighted F1; the dashed line marks the
